    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 20px" }}>
      <div style={{ background: "#0d1117", border: "1px solid #1f2937", borderRadius: 16, padding: 24 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(195px, 1fr))", gap: 14 }}>
          ...
          <div>
            <label style={lbl}>MFE Extreme Price</label>
            <input type="number" step="0.1" value={form.mfePrice} onChange={e => set("mfePrice", e.target.value)} placeholder={form.direction === "Short" ? "Lowest price reached" : "Highest price reached"} style={inp} />
          </div>
          <div>
            <label style={{ ...lbl, color: "#f5c842" }}>MFE Points <AutoBadge /></label>
            <input readOnly value={form.mfe} placeholder="--" style={autoInp} />
          </div>

...
//   B. Per-Trade AI Review — sends one trade + its screenshots to Claude
        ...
        {reviewLoading && (
          <div style={{ background: "#070b12", border: "1px solid #1f2937", borderRadius: 10, padding: 24, textAlign: "center" }}>
            ...
            <div style={{ fontSize: 10, color: "#4b5563" }}>
              Claude is analysing {reviewTrade?.screenshots?.length > 0 ? `${reviewTrade.screenshots.length} screenshot(s) and` : ""} trade data
            </div>
          </div>
        )}

...
export default function GCJournal() {
  ...
  const totalExpenses = expenses.reduce(
    (sum, e) => sum + calcExpenseTotal(e),
    0
  );

  const netTradingIncome = totalPayouts - totalExpenses;

  const estimatedTaxes = Math.max(0, netTradingIncome * taxRate);

  const afterTaxProfit = netTradingIncome - estimatedTaxes;
...
{view === "taxes" && (
  <div style={{ padding: 24 }}>
    ...
    <h2 style={{ color: "#e6edf3", marginBottom: 20 }}>
      Tax Reserve Planner
    </h2>
    ...
    >
      ...
      <div style={taxCard}>
        <div style={taxLabel}>Total Payouts</div>
        <div style={taxValue}>
      ...
      <div style={taxCard}>
        <div style={taxLabel}>Total Expenses</div>
        <div style={taxValue}>
      ...
      <div style={taxCard}>
        <div style={taxLabel}>Net Trading Income</div>
        <div style={{
          ...taxValue,
          color: netTradingIncome >= 0 ? "#00e5a0" : "#ff4d6d"
        }}>
          ${netTradingIncome.toLocaleString()}
        </div>
      </div>

      <div style={taxCard}>
        <div style={taxLabel}>Estimated Taxes</div>
        <div style={{ ...taxValue, color: "#f5c842" }}>
          ${estimatedTaxes.toLocaleString()}
        </div>
      </div>

      <div style={taxCard}>
        <div style={taxLabel}>After-Tax Profit</div>
        <div style={{ ...taxValue, color: "#3b82f6" }}>
          ${afterTaxProfit.toLocaleString()}
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        <option value={0.30}>30% Safe</option>
        <option value={0.35}>35% Very Safe</option>
      </select>
      ...
      <div style={{
        ...
        Based on your ~$32k Army taxable income, trading payouts will likely
        fall into the 22% federal bracket. Keeping 30% reserved is usually a
